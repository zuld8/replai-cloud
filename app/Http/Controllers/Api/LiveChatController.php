...
class LiveChatController extends Controller
{
    ...
    private function processAIReply($livechat, $history, string $message, $setting, int $followUps, $imagePath = null)
    {
        $fineTunnel = $livechat->finetunnel;
        ...
        // Detect intent with optional image
        $intent_data = $this->detectIntent($livechat, $history, $message, $imagePath);
    ...
    private function detectIntent($livechat, $history, string $message, $imagePath = null): array
    {
        $fineTunnel = $livechat->finetunnel;
