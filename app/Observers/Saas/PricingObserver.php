...
class PricingObserver
{
    ...
    public function createData(Request $request)
    {
        return Package::create([
            ...
            'message_limit_option'          => $request->message_limit_option ?? 'no',
            'message_limit'                 => ($request->message_limit_option ?? 'no') == 'yes' ? (int)$request->message_limit : 0,
            'message_limit_priode'          => $request->message_limit_priode ?? 'monthly',
