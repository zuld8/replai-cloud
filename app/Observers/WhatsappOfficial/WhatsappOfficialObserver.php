...
class WhatsappOfficialObserver
{
    ...
    {
        // FIX: Untuk akun via Facebook Login (embedded signup), gunakan
        // platform fb_app_id agar Resumable Upload API template bisa digunakan.
        // app_id dari user mungkin tidak punya izin upload di Meta.
        $platformSetting = \App\Models\InternalSetting::first(['fb_app_id']);
        $resolvedAppId = ($platformSetting && $platformSetting->fb_app_id)
