...
class WhatsappTemplateServiceObserver
{
    ...
    public function buildTemplate(BlashWhatsapp $campaign)
    {
        ...
        if (!empty($templateDetails['body']) && !empty($templateDetails['body']['parameters'])) {
            // FIX: Only include body component if variables exist (non-empty parameters)
            // Sending body:{parameters:[]} to Meta for fixed-text templates causes error 132001
