...
class StoreExport implements FromQuery, WithHeadings, WithMapping, WithColumnWidths, WithStyles
{
    use Exportable;
    ...
    public function __construct(Request $request, StoreObserver $storeObserver)
    {
    ...
    {
        return $this->storeObserver->getData($this->request);
    }
