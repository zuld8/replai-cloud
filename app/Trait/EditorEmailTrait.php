...
trait EditorEmailTrait
{
    ...
    { 
        $extrackBody    = json_decode($this->message);
    ...
    {
        return route('templatemail.edit', $this->getKeyValue());
    }

    public function getTemplatesUrlAttribute(): ?string
    {
        return route('templatemail.components', $this->getKeyValue());
    }
