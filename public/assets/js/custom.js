...
(function () {
    ...
    function toggleTheme() {
        ...
        // Re-apply saved theme preset after toggle
        setTimeout(function() {
            if (window._reapplyThemePreset) window._reapplyThemePreset();
        }, 100);
    }
    ...
    /* node waves */
    if (typeof Waves !== 'undefined') { Waves.attach('.btn-wave', ['waves-light']); Waves.init(); }
    /* node waves */
