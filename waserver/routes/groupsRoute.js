...
router.get('/group-data/:id', query('id').notEmpty(),requestValidator, sessionValidator, controller.getGroupData)
router.get('/scraping-data/:id', query('id').notEmpty(),requestValidator, sessionValidator, controller.getGroups)
