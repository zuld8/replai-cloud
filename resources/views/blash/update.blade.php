...
@section('content')
<form action="<?= route('blash.edit', $blash->id); ?>" method="POST" class="row d-flex justify-content-center">
    @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 mb-4">
                        ...
                        <select class="form-control" name="whatsapp_sender_notif" required>
                            <option value="sequence" @if($blash->whatsapp_sender_notif == 'sequence') selected @endif>
                                {{ __('broadcast.wa.device_sequence') }}
                            </option>
                            <option value="spin" @if($blash->whatsapp_sender_notif == 'spin') selected @endif>
                                {{ __('broadcast.wa.device_spin') }}
                            </option>
                            <option value="random" @if($blash->whatsapp_sender_notif == 'random') selected @endif>
                                {{ __('broadcast.wa.device_random') }}
                            </option>
                        </select>
                        <small class="text-muted">
                            <i class="bx bx-info-circle"></i>
                    ...
                    <div class="col-lg-4 mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number"
                                ...
                                min="10"
                                max="300"
                                value="<?= old('delay', $blash->delay) ?? 60; ?>">
                    ...
                    <div class="col-lg-4 mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number"
                                ...
                                min="10"
                                max="300"
                                value="<?= old('stop_sending', $blash->stop_sending) ?? 20; ?>">
                    ...
                    <div class="col-lg-4 mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number"
                                ...
                                min="10"
                                max="300"
                                value="<?= old('rest_sending', $blash->rest_sending) ?? 90; ?>">
                            <span class="input-group-text">{{ __('broadcast.wa.seconds') }}</span>
                        </div>
                        <small class="text-muted">
                            <i class="bx bx-info-circle"></i>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-4">
                        ...
                        <select class="form-control groups" name="group">
                            ...
                            <option value="<?= $group->id; ?>" @if($group->id == $blash->group_id) selected @endif>
                                <?= $group->name; ?>
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 mb-4">
                            ...
                            <select class="form-control provinces" name="province">
                                ...
                                <option value="<?= $province->id; ?>" @if(($blash->city->province_id ?? '') == $province->id) selected @endif>
                                    <?= $province->name; ?>
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-lg-4 mb-4">
                            ...
                            <select class="form-control districts" name="district">
                                <option value="<?= $blash->district_id ?? ''; ?>">
                                    <?= $blash->district->name ?? __('master.directory.choose_district'); ?>
                                </option>
                            </select>
                            <small class="text-muted">
                                <i class="bx bx-info-circle"></i>
