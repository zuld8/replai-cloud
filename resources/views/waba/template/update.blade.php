...
@section('button')
<div class="btn-list">
    <a href="{{route('waba.templates',$meta->id)}}" class="btn btn-primary d-none d-sm-inline-block">
        <i class="bx bx-chevron-left"></i>
        {{__('master.template.back_to')}}
    </a>
    <a href="{{route('waba.templates',$meta->id)}}" class="btn btn-info d-sm-none btn-icon" aria-label="{{__('master.template.back_to')}}">
        <i class="bx bx-chevron-left"></i>
    </a>
</div>
@endsection
