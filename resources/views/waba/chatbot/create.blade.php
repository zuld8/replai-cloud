...
@section('button')
<div class="btn-list">
    <a href="{{route('waba.chatbot',$meta->id)}}" class="btn btn-primary d-none d-sm-inline-block">
        <i class="bx bx-chevron-left"></i>
        {{__('blash.back_to')}}
    </a>
    <a href="{{route('waba.chatbot',$meta->id)}}" class="btn btn-info d-sm-none btn-icon" aria-label="{{__('blash.back_to')}}">
        <i class="bx bx-chevron-left"></i>
    </a>
</div>
@endsection
    ...
    <div class="col-xl-12">
        ...
        <div class="card">
            <div class="row g-0" id="app">
                ...
                <create-auto-reply></create-auto-reply>
            </div>
        </div>
    </div>
</div>
