...
<div class="btn-list">
    ...
    <a href="{{route('transaction.mua')}}" class="btn btn-primary d-none d-sm-inline-block">
        <i class="bx bx-chevron-left"></i>
        Back to MUA Transactions
    </a>

    <a href="{{route('transaction.mua')}}" class="btn btn-info d-sm-none btn-icon" aria-label="Back">
        <i class="bx bx-chevron-left"></i>
    </a>
</div>
@endsection
                                ...
                                <div class="card bg-primary bg-gradient text-white border-0 h-100">
                                    <div class="card-body">
                                        ...
                                        <h2 class="text-white mb-2">
                                            {{number_format($transaction->new_order_mua_limit)}}
                                        </h2>
                                        <p class="text-white-50 mb-0">Monthly Active Users</p>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <p class="fw-semibold text-muted mb-0">Created Date:</p>
                                                <p class="fs-6 mb-0">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <p class="fw-semibold text-muted mb-0">Payment Date:</p>
                                                <p class="fs-6 mb-0">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <p class="fw-semibold text-muted mb-0">Status:</p>
                            ...
                            <table class="table table-bordered">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="text-center">MUA Limit</th>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <p class="mb-0 fw-semibold">Top Up MUA (Monthly Active Users)</p>
                                                    <small class="text-muted">
                                                        Increase monthly active user limit for chatbot interactions
                                                    </small>
                                                </div>
                                            </div>
                                        </td>
...
<script>
    $(".approvebutton").on("click", function(e) {
        ...
        Swal.fire({
            title: "Approve MUA Payment?",
            text: "This will add " + "{{number_format($transaction->new_order_mua_limit)}}" + " MUA limit to the business account.",
            icon: "question",
    ...
    $(".deletebutton").on("click", function(e) {
        ...
        Swal.fire({
            ...
            text: "This action will reject the payment and return status to pending.",
            icon: "warning",
            showCancelButton: true,
