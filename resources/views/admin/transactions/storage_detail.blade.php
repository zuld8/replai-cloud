...
<div class="btn-list">
    ...
    <a href="{{route('transaction.storage')}}" class="btn btn-primary d-none d-sm-inline-block">
        <i class="bx bx-chevron-left"></i>
        {{__('transaction.back_to')}}
    </a>

    <a href="{{route('transaction.storage')}}" class="btn btn-info d-sm-none btn-icon" aria-label="{{__('transaction.back_to')}}">
        <i class="bx bx-chevron-left"></i>
    </a>
</div>
@endsection
                                ...
                                <div class="card bg-warning bg-gradient text-white border-0 h-100">
                                    <div class="card-body">
                                        <p class="text-white-50 mb-3 fw-semibold">
                                            <i class="bx bx-hdd me-1"></i>
                                            Storage Package:
                                        </p>
                                        <h2 class="text-white mb-2">
                                            {{$transaction->storage_name}}
                                        </h2>
                                        <p class="text-white-50 mb-0">{{$transaction->package->name ?? 'Storage Package'}}</p>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                <thead class="table-light">
                                    <tr>
                                        <th width="60%">Storage Package</th>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <p class="mb-0 fw-semibold">{{$transaction->package->name ?? 'Storage Package'}}</p>
                                                    <small class="text-muted">
                                ...
                                <tfoot class="table-light">
                                    <tr>
                                        ...
                                        <th class="text-end fs-5 text-warning">
                                            Rp {{number_format($transaction->final_total)}}
                                        </th>
                                    </tr>
                                </tfoot>
...
<script>
    $(".approvebutton").on("click", function(e) {
        ...
        Swal.fire({
            title: "Approve Storage Purchase?",
            text: "This will add " + "{{$transaction->storage_name}}" + " storage to the account.",
            icon: "question",
