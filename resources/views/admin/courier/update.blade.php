...
<div class="row">
    <div class="col-xl-12">
        <form action="<?= route('courier.edit', $courier->id); ?>" enctype="multipart/form-data" method="POST" class="card custom-card">
            @csrf
                    ...
                    <div class="col-12">
                        <div class="row">
                            <div class="col-lg-6 col-sm-12 mt-3">
                                ...
                                <input class="form-control" name="name" value="{{old('name',$courier->name)}}" type="text" required>
                            </div>
                            <div class="col-lg-6 col-sm-12 mt-3">
                                <label class="form-label">{{__('courier.courier_code')}}</label>
                                <input class="form-control" name="code" value="{{old('code',$courier->code)}}" type="text" required>
                            </div> 
                        </div>
                    </div>
                </div>
