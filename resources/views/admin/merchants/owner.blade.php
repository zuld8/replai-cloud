...
<div class="row">
    ...
    <div class="col-lg-8 col-sm-12 mt-4">
        <form action="<?= route('merchants.owner.edit',$merchant->id); ?>" enctype="multipart/form-data" method="POST" class="card custom-card">
            @csrf
            <div class="card-header">
                <div class="card-title">
                    {{__('merchant.business_owner_edit')}}
                </div>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-12 mt-3">
                        ...
                        <input class="form-control" name="phone" value="<?=$user->phone; ?>" type="number" required>
                    </div>
                    <div class="col-12 mt-3">
    ...
    <div class="col-lg-4 col-sm-12 mt-4">
        <form action="<?= route('merchants.owner.password',$merchant->id); ?>" method="POST" class="card custom-card">
            @csrf
            <div class="card-header">
                <div class="card-title">
