...
<div class="btn-list">
    ...
    <a href="{{route('merchant.categories.create')}}" class="btn btn-info d-sm-none btn-icon" aria-label="{{__('general.add_data')}}">
        <i class="bx bx-plus-circle"></i>
    </a>
</div>
@endsection
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <span class="badge bg-info p-2"> {{number_format($category->merchants->count())}}</span>
                            </td>
                            <td>
