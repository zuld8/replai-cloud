...
@section('content')
<form action="<?= route('package.storage.edit', $package->id); ?>" enctype="multipart/form-data" method="POST" class="row">
    @csrf
    <div class="col-12">
            ...
            <div class="card-body row">
                ...
                <div class="col-lg-6 col-sm-12 mt-3">
                    ...
                    <select class="form-control dayoption" name="days_option">
                        <option value="limited" @if(old('days_option',$package->days_option)=='limited' ) selected @endif>{{__('package.limited')}}</option>
                        <option value="unlimited" @if(old('days_option',$package->days_option)=='unlimited' ) selected @endif>{{__('package.unlimited')}}</option>
                    </select>
                </div>

                <div class="col-lg-6 col-sm-12 mt-3 @if(old('days_option',$package->days_option) == 'unlimited') d-none @endif formdays">
                ...
                <div class="col-lg-6 col-sm-12 mt-3 ">
                    ...
                    <input class="form-control" name="storage" value="{{old('storage',$package->storage)}}" type="number" required>
                </div>
    ...
    <div class="col-12">
        <button type="submit" class="btn btn-primary w-100">{{__('package.save_changes')}}</button>
    </div>
</form>
@endsection
