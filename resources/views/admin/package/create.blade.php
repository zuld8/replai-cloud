            ...
            <div class="card-body row">
                ...
                <div class="col-lg-6 col-sm-12 mt-2">
                    ...
                    <div class="input-group">
                        ...
                        <input class="form-control" name="name" value="{{old('name')}}" type="text" placeholder="{{__('auth.package_example')}}" required>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-sm-12 mt-2">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-control dayoption" name="days_option">
                            <option value="limited" @if(old('days_option')=='limited' ) selected @endif>{{__('auth.subscription_limited')}}</option>
                            <option value="unlimited" @if(old('days_option')=='unlimited' ) selected @endif>{{__('auth.subscription_unlimited')}}</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-sm-12 mt-2 @if(old('days_option') == 'unlimited') d-none @endif formdays">
                    ...
                    <div class="input-group">
                        ...
                        <input class="form-control" name="add_days" value="{{old('add_days',0)}}" type="number" placeholder="30" required>
                ...
                <div class="col-lg-6 col-sm-12 mt-2">
                    ...
                    <div class="input-group">
                        ...
                        <input class="form-control" name="storage" value="{{old('storage',0)}}" type="number" placeholder="1024" required>
                ...
                <div class="col-lg-6 col-sm-12 mt-2">
                    ...
                    <div class="input-group">
                        ...
                        <input class="form-control" name="ai_response" value="{{old('ai_response',0)}}" type="number" placeholder="1024" required>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-sm-12 mt-2">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-control trialversion" name="trial_version">
                            ...
                            <option value="no" @if(old('trial_version')=='no' ) selected @endif>{{__('general.no')}}</option>
                            <option value="yes" @if(old('trial_version')=='yes' ) selected @endif>{{__('general.yes')}}</option>
                        </select>
                    </div>
                </div>

                <!-- Harga -->
                <div class="col-lg-6 col-sm-12 mt-2 @if(old('trial_version') != 'no') d-none @endif formprice">
                    ...
                    <div class="input-group">
                        ...
                        <input class="form-control" name="price" value="{{old('price')}}" type="number" placeholder="100000">
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-sm-12 mt-2">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-control" name="cek_ongkir">
                            <option value="">{{__('general.choose')}}</option>
                            <option value="no" @if(old('cek_ongkir')=='no' ) selected @endif>{{__('general.no')}}</option>
                            <option value="yes" @if(old('cek_ongkir')=='yes' ) selected @endif>{{__('general.yes')}}</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-sm-12 mt-2">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-control" name="google_sheet">
                            <option value="">{{__('general.choose')}}</option>
                            <option value="no" @if(old('google_sheet')=='no' ) selected @endif>{{__('general.no')}}</option>
                            <option value="yes" @if(old('google_sheet')=='yes' ) selected @endif>{{__('general.yes')}}</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-sm-12 mt-2">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-control" id="muaOption" name="mua_limit_optin">
                            <option value="">{{__('general.choose')}}</option>
                            <option value="no" @if(old('mua_limit_optin')=='no' ) selected @endif>{{__('general.no')}}</option>
                            <option value="yes" @if(old('mua_limit_optin')=='yes' ) selected @endif>{{__('general.yes')}}</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-sm-12 mt-2 muaOption d-none">
                    ...
                    <div class="input-group">
                        ...
                        <input class="form-control" name="mua_limit" value="{{old('mua_limit',0)}}" type="number" placeholder="1024" required>
                    </div>
                </div>
                <!-- End Mua -->
            </div>
    ...
    <div class="col-12">
        <div class="card mb-4">
            ...
            <div class="card-body row">
                ...
                <div class="col-lg-6 col-sm-12 mt-2">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-control limitdevice" name="limit_device" required>
                            <option value="">{{__('general.choose')}}</option>
                            <option value="no" @if(old('limit_device')=='no' ) selected @endif>{{__('auth.unlimited')}}</option>
                            <option value="yes" @if(old('limit_device')=='yes' ) selected @endif>{{__('auth.limited')}}</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-sm-12 mt-2">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-control limitwhatsapp" name="limit_whatsapp_option" required>
                            <option value="">{{__('general.choose')}}</option>
                            <option value="no" @if(old('limit_whatsapp_option')=='no' ) selected @endif>{{__('auth.unlimited')}}</option>
                            <option value="yes" @if(old('limit_whatsapp_option')=='yes' ) selected @endif>{{__('auth.limited')}}</option>
                        </select>
                    </div>
                </div>

                <!-- Device Limit -->
                <div class="col-lg-6 col-sm-12 mt-2 @if(old('limit_device') != 'yes') d-none @endif formdevice">
                ...
                <!-- WhatsApp Period -->
                <div class="col-lg-6 col-sm-12 mt-2 formwhatsapp-priode @if(old('limit_whatsapp_option') != 'yes') d-none @endif">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-control" name="limit_whatsapp_priode">
                            <option value="daily" @if(old('limit_whatsapp_priode')=='daily' ) selected @endif>{{__('auth.period_daily')}}</option>
                            <option value="monthly" @if(old('limit_whatsapp_priode')=='monthly' ) selected @endif>{{__('auth.period_monthly')}}</option>
                            <option value="yearly" @if(old('limit_whatsapp_priode')=='yearly' ) selected @endif>{{__('auth.period_yearly')}}</option>
                        </select>
                    </div>
                </div>

                <!-- WhatsApp Limit Count -->
                <div class="col-lg-6 col-sm-12 mt-2 formwhatsapp @if(old('limit_whatsapp_option') != 'yes') d-none @endif">
                ...
                <div class="col-lg-6 col-sm-12 mt-2">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-control limitwaba" name="limit_waba" required>
                            <option value="">{{__('general.choose')}}</option>
                            <option value="no" @if(old('limit_waba')=='no' ) selected @endif>{{__('auth.unlimited')}}</option>
                            <option value="yes" @if(old('limit_waba')=='yes' ) selected @endif>{{__('auth.limited')}}</option>
                        </select>
                    </div>
                </div>

                <!-- WABA Account Limit -->
                <div class="col-lg-6 col-sm-12 mt-2 formwaba @if(old('limit_waba') != 'yes') d-none @endif">
                    <label class="form-label">WABA Account Limit</label>
                    <div class="input-group">
                        <span class="input-group-text">
                            <i class="bx bx-hash"></i>
                        </span>
                        <input class="form-control" name="waba_limit" value="{{old('waba_limit')}}" type="number" placeholder="5">
                ...
                <div class="col-lg-6 col-sm-12 mt-2">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-control limittelegram" name="limit_telegram" required>
                            <option value="">{{__('general.choose')}}</option>
                            <option value="no" @if(old('limit_telegram')=='no' ) selected @endif>{{__('auth.unlimited')}}</option>
                            <option value="yes" @if(old('limit_telegram')=='yes' ) selected @endif>{{__('auth.limited')}}</option>
                        </select>
                    </div>
                </div>

                <!-- Telegram Limit -->
                <div class="col-lg-6 col-sm-12 mt-2 formtelegram @if(old('limit_telegram') != 'yes') d-none @endif">
                    <label class="form-label">{{__('auth.telegram_limit')}}</label>
                    <div class="input-group">
                        <span class="input-group-text">
                            <i class="bx bx-hash"></i>
                        </span>
                        <input class="form-control" name="telegram" value="{{old('telegram')}}" type="number" placeholder="5">
                        <span class="input-group-text">Akun</span>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-6 col-sm-12 mt-2">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-control limitinstagram" name="limit_instagram" required>
                            <option value="">{{__('general.choose')}}</option>
                            <option value="no" @if(old('limit_instagram')=='no' ) selected @endif>{{__('auth.unlimited')}}</option>
                            <option value="yes" @if(old('limit_instagram')=='yes' ) selected @endif>{{__('auth.limited')}}</option>
                        </select>
                    </div>
                </div>

                <!-- Instagram Limit -->
                <div class="col-lg-6 col-sm-12 mt-2 forminstagram @if(old('limit_instagram') != 'yes') d-none @endif">
                    <label class="form-label">{{__('auth.instagram_limit')}}</label>
                    <div class="input-group">
                        <span class="input-group-text">
                            <i class="bx bx-hash"></i>
                        </span>
                        <input class="form-control" name="instagram" value="{{old('instagram')}}" type="number" placeholder="5">
                        <span class="input-group-text">Akun</span>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-6 col-sm-12 mt-2">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-control limitmessanger" name="limit_messanger" required>
                            <option value="">{{__('general.choose')}}</option>
                            <option value="no" @if(old('limit_messanger')=='no' ) selected @endif>{{__('auth.unlimited')}}</option>
                            <option value="yes" @if(old('limit_messanger')=='yes' ) selected @endif>{{__('auth.limited')}}</option>
                        </select>
                    </div>
                </div>

                <!-- Messenger Limit -->
                <div class="col-lg-6 col-sm-12 mt-2 formmessanger @if(old('limit_messanger') != 'yes') d-none @endif">
                    <label class="form-label">{{__('auth.messenger_limit')}}</label>
                    <div class="input-group">
                        <span class="input-group-text">
                            <i class="bx bx-hash"></i>
                        </span>
                        <input class="form-control" name="messanger" value="{{old('messanger')}}" type="number" placeholder="5">
                        <span class="input-group-text">Akun</span>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-6 col-sm-12 mt-2">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-control livechatlimit" name="livechat_limit" required>
                            <option value="">{{__('general.choose')}}</option>
                            <option value="no" @if(old('livechat_limit')=='no' ) selected @endif>{{__('auth.unlimited')}}</option>
                            <option value="yes" @if(old('livechat_limit')=='yes' ) selected @endif>{{__('auth.limited')}}</option>
                        </select>
                    </div>
                </div>

                <!-- LiveChat Limit -->
                <div class="col-lg-6 col-sm-12 mt-2 formlivechat @if(old('livechat_limit') != 'yes') d-none @endif">
                ...
                <div class="col-lg-6 col-sm-12 mt-2">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-control limituser" name="limit_user_option" required>
                            <option value="">{{__('general.choose')}}</option>
                            <option value="no" @if(old('limit_user_option')=='no' ) selected @endif>{{__('auth.unlimited')}}</option>
                            <option value="yes" @if(old('limit_user_option')=='yes' ) selected @endif>{{__('auth.limited')}}</option>
                        </select>
                    </div>
                </div>

                <!-- User Limit -->
                <div class="col-lg-6 col-sm-12 mt-2 formlimituser @if(old('limit_user_option') != 'yes') d-none @endif">
                    <label class="form-label">{{__('auth.user_limit')}}</label>
                    <div class="input-group">
                        <span class="input-group-text">
                            <i class="bx bx-group"></i>
                        </span>
                        <input class="form-control" name="users_limit" value="{{old('users_limit')}}" type="number" placeholder="10">
                ...
                <div class="col-lg-6 col-sm-12 mt-2">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-control templatelimit" name="limit_template" required>
                            <option value="">{{__('general.choose')}}</option>
                            <option value="no" @if(old('limit_template')=='no' ) selected @endif>{{__('auth.unlimited')}}</option>
                            <option value="yes" @if(old('limit_template')=='yes' ) selected @endif>{{__('auth.limited')}}</option>
                        </select>
                    </div>
                </div>

                <!-- Template Limit -->
                <div class="col-lg-6 col-sm-12 mt-2 formtemplate @if(old('limit_template') != 'yes') d-none @endif">
                    <label class="form-label">{{__('auth.template_limit')}}</label>
                    <div class="input-group">
                        <span class="input-group-text">
                            <i class="bx bx-hash"></i>
                        </span>
                        <input class="form-control" name="template_limit" value="{{old('template_limit')}}" type="number" placeholder="50">
                ...
                <div class="col-lg-6 col-sm-12 mt-2">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-control chatbotlimit" name="limit_chatbot" required>
                            <option value="">{{__('general.choose')}}</option>
                            <option value="no" @if(old('limit_chatbot')=='no' ) selected @endif>{{__('auth.unlimited')}}</option>
                            <option value="yes" @if(old('limit_chatbot')=='yes' ) selected @endif>{{__('auth.limited')}}</option>
                        </select>
                    </div>
                </div>

                <!-- ChatBot Limit -->
                <div class="col-lg-6 col-sm-12 mt-2 formchatbot @if(old('limit_chatbot') != 'yes') d-none @endif">
                ...
                <div class="col-lg-6 col-sm-12 mt-2">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-control ailimit" name="limit_ai_training" required>
                            <option value="">{{__('general.choose')}}</option>
                            <option value="no" @if(old('limit_ai_training')=='no' ) selected @endif>{{__('auth.unlimited')}}</option>
                            <option value="yes" @if(old('limit_ai_training')=='yes' ) selected @endif>{{__('auth.limited')}}</option>
                        </select>
                    </div>
                </div>

                <!-- AI Training Limit -->
                <div class="col-lg-6 col-sm-12 mt-2 formai @if(old('limit_ai_training') != 'yes') d-none @endif">
                ...
                <div class="col-lg-6 col-sm-12 mt-2">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-control emaillimit" name="limit_email_option" required>
                            <option value="">{{__('general.choose')}}</option>
                            <option value="no" @if(old('limit_email_option')=='no' ) selected @endif>{{__('auth.unlimited')}}</option>
                            <option value="yes" @if(old('limit_email_option')=='yes' ) selected @endif>{{__('auth.limited')}}</option>
                        </select>
                    </div>
                </div>

                <!-- Email Period -->
                <div class="col-lg-6 col-sm-12 mt-2 formemail-priode @if(old('limit_email_option') != 'yes') d-none @endif">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-control" name="limit_email_priode">
                            <option value="daily" @if(old('limit_email_priode')=='daily' ) selected @endif>{{__('auth.period_daily')}}</option>
                            <option value="monthly" @if(old('limit_email_priode')=='monthly' ) selected @endif>{{__('auth.period_monthly')}}</option>
                            <option value="yearly" @if(old('limit_email_priode')=='yearly' ) selected @endif>{{__('auth.period_yearly')}}</option>
                        </select>
                    </div>
                </div>

                <!-- Email Limit Count -->
                <div class="col-lg-6 col-sm-12 mt-2 formemail @if(old('limit_email_option') != 'yes') d-none @endif">
                    <label class="form-label">{{__('auth.email_limit')}}</label>
                    <div class="input-group">
                        <span class="input-group-text">
                            <i class="bx bx-send"></i>
                        </span>
                        <input class="form-control" name="email_limit" value="{{old('email_limit')}}" type="number" placeholder="500">
                ...
                <div class="col-lg-6 col-sm-12 mt-2">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-control scrappinglimit" name="limit_scrapp_option" required>
                            <option value="">{{__('general.choose')}}</option>
                            <option value="no" @if(old('limit_scrapp_option')=='no' ) selected @endif>{{__('auth.unlimited')}}</option>
                            <option value="yes" @if(old('limit_scrapp_option')=='yes' ) selected @endif>{{__('auth.limited')}}</option>
                        </select>
                    </div>
                </div>

                <!-- Scraping Period -->
                <div class="col-lg-6 col-sm-12 mt-2 formscrapping-priode @if(old('limit_scrapp_option') != 'yes') d-none @endif">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-control" name="limit_scrapp_priode">
                            <option value="daily" @if(old('limit_scrapp_priode')=='daily' ) selected @endif>{{__('auth.period_daily')}}</option>
                            <option value="monthly" @if(old('limit_scrapp_priode')=='monthly' ) selected @endif>{{__('auth.period_monthly')}}</option>
                            <option value="yearly" @if(old('limit_scrapp_priode')=='yearly' ) selected @endif>{{__('auth.period_yearly')}}</option>
                        </select>
                    </div>
                </div>

                <!-- Scraping Limit Count -->
                <div class="col-lg-6 col-sm-12 mt-2 formscrapping @if(old('limit_scrapp_option') != 'yes') d-none @endif">
                    <label class="form-label">{{__('auth.scraping_limit')}}</label>
                    <div class="input-group">
                        <span class="input-group-text">
                            <i class="bx bx-download"></i>
                        </span>
                        <input class="form-control" name="scrapp_limit" value="{{old('scrapp_limit')}}" type="number" placeholder="100">
