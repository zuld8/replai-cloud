                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-12 mt-2">
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-control dayoption" name="days_option">
                                <option value="limited" @if(old('days_option',$package->days_option)=='limited' ) selected @endif>Berhari-hari</option>
                                <option value="unlimited" @if(old('days_option',$package->days_option)=='unlimited' ) selected @endif>Selamanya</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-sm-12 mt-2">
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control" name="ai_response" value="{{old('ai_response',(int)$package->ai_response)}}" type="number" placeholder="1000" required>
                        </div>
                    ...
                    <div class="col-lg-6 col-sm-12 mt-2">
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-control trialversion" name="trial_version">
                                ...
                                <option value="no" @if(old('trial_version',$package->trial_version) == 'no') selected @endif>Tidak (berbayar)</option>
                                <option value="yes" @if(old('trial_version',$package->trial_version) == 'yes') selected @endif>Ya (gratis trial)</option>
                            </select>
                        </div>
                    </div>

                    {{-- Harga --}}
                    <div class="col-lg-6 col-sm-12 mt-2 @if(old('trial_version',$package->trial_version) == 'yes') d-none @endif formprice">
                        <label class="form-label">{{__('auth.price')}} <span class="text-danger">*</span></label>
                        <div class="input-group">
                            <span class="input-group-text">Rp</span>
                            <input class="form-control" name="price" value="{{old('price',(int)$package->price)}}" type="number" placeholder="99000">
                        </div>
                    </div>
                </div>
                ...
                <div class="pkg-chip-row mt-3 pt-3" style="border-top:1px solid #EEF2F7;">
                    ...
                    <div class="pkg-chip">
                        ...
                        <select class="form-control" name="google_sheet" style="width:auto;">
                            <option value="no" @if(old('google_sheet',$package->google_sheet)=='no') selected @endif>Nonaktif</option>
                            <option value="yes" @if(old('google_sheet',$package->google_sheet)=='yes') selected @endif>Aktif</option>
                        </select>
                    </div>
                    <div class="pkg-chip">
                        ...
                        <select class="form-control" id="muaOption" name="mua_limit_optin" style="width:auto;">
                            <option value="no" @if(old('mua_limit_optin',$package->mua_limit_optin)=='no') selected @endif>Nonaktif</option>
                            <option value="limited" @if(old('mua_limit_optin',$package->mua_limit_optin)=='limited') selected @endif>Aktif</option>
                        </select>
                        <div class="muaOption @if(old('mua_limit_optin',$package->mua_limit_optin) != 'limited') d-none @endif ms-2">
                            <div class="input-group input-group-sm">
                                <input class="form-control" name="mua_limit" value="{{old('mua_limit',(int)$package->mua_limit)}}" type="number" placeholder="100" style="width:80px;" required>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="form-control limitdevice" name="limit_device" required>
                                    <option value="no" @if(old('limit_device',$package->limit_device)=='no') selected @endif>Tidak Terbatas</option>
                                    <option value="yes" @if(old('limit_device',$package->limit_device)=='yes') selected @endif>Terbatas</option>
                                </select>
                            </td>
                            <td>
                                <span class="badge-unlimited formdevice-inf @if(old('limit_device',$package->limit_device) == 'yes') d-none @endif">∞</span>
                                <div class="formdevice @if(old('limit_device',$package->limit_device) != 'yes') d-none @endif">
                                    <div class="input-group input-group-sm">
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="form-control limitwaba" name="limit_waba" required>
                                    <option value="no" @if(old('limit_waba',$package->limit_waba)=='no') selected @endif>Tidak Terbatas</option>
                                    <option value="yes" @if(old('limit_waba',$package->limit_waba)=='yes') selected @endif>Terbatas</option>
                                </select>
                            </td>
                            <td>
                                <span class="badge-unlimited formwaba-inf @if(old('limit_waba',$package->limit_waba) == 'yes') d-none @endif">∞</span>
                                <div class="formwaba @if(old('limit_waba',$package->limit_waba) != 'yes') d-none @endif">
                                    <div class="input-group input-group-sm">
                                        <input class="form-control" name="waba_limit" value="{{old('waba_limit',(int)$package->waba_limit)}}" type="number" placeholder="1">
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="form-control limittelegram" name="limit_telegram" required>
                                    <option value="no" @if(old('limit_telegram',$package->limit_telegram)=='no') selected @endif>Tidak Terbatas</option>
                                    <option value="yes" @if(old('limit_telegram',$package->limit_telegram)=='yes') selected @endif>Terbatas</option>
                                </select>
                            </td>
                            <td>
                                <span class="badge-unlimited formtelegram-inf @if(old('limit_telegram',$package->limit_telegram) == 'yes') d-none @endif">∞</span>
                                <div class="formtelegram @if(old('limit_telegram',$package->limit_telegram) != 'yes') d-none @endif">
                                    <div class="input-group input-group-sm">
                                        <input class="form-control" name="telegram" value="{{old('telegram',(int)$package->telegram)}}" type="number" placeholder="3">
                                        <span class="input-group-text">Akun</span>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="form-control limitinstagram" name="limit_instagram" required>
                                    <option value="no" @if(old('limit_instagram',$package->limit_instagram)=='no') selected @endif>Tidak Terbatas</option>
                                    <option value="yes" @if(old('limit_instagram',$package->limit_instagram)=='yes') selected @endif>Terbatas</option>
                                </select>
                            </td>
                            <td>
                                <span class="badge-unlimited forminstagram-inf @if(old('limit_instagram',$package->limit_instagram) == 'yes') d-none @endif">∞</span>
                                <div class="forminstagram @if(old('limit_instagram',$package->limit_instagram) != 'yes') d-none @endif">
                                    <div class="input-group input-group-sm">
                                        <input class="form-control" name="instagram" value="{{old('instagram',(int)$package->instagram)}}" type="number" placeholder="1">
                                        <span class="input-group-text">Akun</span>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="form-control limitmessanger" name="limit_messanger" required>
                                    <option value="no" @if(old('limit_messanger',$package->limit_messanger)=='no') selected @endif>Tidak Terbatas</option>
                                    <option value="yes" @if(old('limit_messanger',$package->limit_messanger)=='yes') selected @endif>Terbatas</option>
                                </select>
                            </td>
                            <td>
                                <span class="badge-unlimited formmessanger-inf @if(old('limit_messanger',$package->limit_messanger) == 'yes') d-none @endif">∞</span>
                                <div class="formmessanger @if(old('limit_messanger',$package->limit_messanger) != 'yes') d-none @endif">
                                    <div class="input-group input-group-sm">
                                        <input class="form-control" name="messanger" value="{{old('messanger',(int)$package->messanger)}}" type="number" placeholder="1">
                                        <span class="input-group-text">Akun</span>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="form-control livechatlimit" name="livechat_limit" required>
                                    <option value="no" @if(old('livechat_limit',$package->livechat_limit)=='no') selected @endif>Tidak Terbatas</option>
                                    <option value="yes" @if(old('livechat_limit',$package->livechat_limit)=='yes') selected @endif>Terbatas</option>
                                </select>
                            </td>
                            <td>
                                <span class="badge-unlimited formlivechat-inf @if(old('livechat_limit',$package->livechat_limit) == 'yes') d-none @endif">∞</span>
                                <div class="formlivechat @if(old('livechat_limit',$package->livechat_limit) != 'yes') d-none @endif">
                                    <div class="input-group input-group-sm">
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="form-control limituser" name="limit_user_option" required>
                                    <option value="no" @if(old('limit_user_option',$package->limit_user_option)=='no') selected @endif>Tidak Terbatas</option>
                                    <option value="yes" @if(old('limit_user_option',$package->limit_user_option)=='yes') selected @endif>Terbatas</option>
                                </select>
                            </td>
                            <td>
                                <span class="badge-unlimited formlimituser-inf @if(old('limit_user_option',$package->limit_user_option) == 'yes') d-none @endif">∞</span>
                                <div class="formlimituser @if(old('limit_user_option',$package->limit_user_option) != 'yes') d-none @endif">
                                    <div class="input-group input-group-sm">
                                        <input class="form-control" name="users_limit" value="{{old('users_limit',(int)$package->users_limit)}}" type="number" placeholder="5">
                                        <span class="input-group-text">User</span>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="form-control templatelimit" name="limit_template" required>
                                    <option value="no" @if(old('limit_template',$package->limit_template)=='no') selected @endif>Tidak Terbatas</option>
                                    <option value="yes" @if(old('limit_template',$package->limit_template)=='yes') selected @endif>Terbatas</option>
                                </select>
                            </td>
                            <td>
                                <span class="badge-unlimited formtemplate-inf @if(old('limit_template',$package->limit_template) == 'yes') d-none @endif">∞</span>
                                <div class="formtemplate @if(old('limit_template',$package->limit_template) != 'yes') d-none @endif">
                                    <div class="input-group input-group-sm">
                                        <input class="form-control" name="template_limit" value="{{old('template_limit',(int)$package->template_limit)}}" type="number" placeholder="20">
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="form-control chatbotlimit" name="limit_chatbot" required>
                                    <option value="no" @if(old('limit_chatbot',$package->limit_chatbot)=='no') selected @endif>Tidak Terbatas</option>
                                    <option value="yes" @if(old('limit_chatbot',$package->limit_chatbot)=='yes') selected @endif>Terbatas</option>
                                </select>
                            </td>
                            <td>
                                <span class="badge-unlimited formchatbot-inf @if(old('limit_chatbot',$package->limit_chatbot) == 'yes') d-none @endif">∞</span>
                                <div class="formchatbot @if(old('limit_chatbot',$package->limit_chatbot) != 'yes') d-none @endif">
                                    <div class="input-group input-group-sm">
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="form-control ailimit" name="limit_ai_training" required>
                                    <option value="no" @if(old('limit_ai_training',$package->limit_ai_training)=='no') selected @endif>Tidak Terbatas</option>
                                    <option value="yes" @if(old('limit_ai_training',$package->limit_ai_training)=='yes') selected @endif>Terbatas</option>
                                </select>
                            </td>
                            <td>
                                <span class="badge-unlimited formai-inf @if(old('limit_ai_training',$package->limit_ai_training) == 'yes') d-none @endif">∞</span>
                                <div class="formai @if(old('limit_ai_training',$package->limit_ai_training) != 'yes') d-none @endif">
                                    <div class="input-group input-group-sm">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-lg-6 col-sm-12">
                        ...
                        <div class="input-group input-group-sm">
                            ...
                            <input class="form-control" name="max_per_upload" value="{{old('max_per_upload',(int)$package->max_per_upload)}}" type="number" placeholder="10">
                            <span class="input-group-text">MB</span>
                        </div>
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        ...
                        <div class="input-group input-group-sm">
                            ...
                            <input class="form-control" name="max_total_rag" value="{{old('max_total_rag',(int)$package->max_total_rag)}}" type="number" placeholder="100">
                            <span class="input-group-text">MB</span>
                        </div>
                    </div>
                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="form-control limitwhatsapp" name="limit_whatsapp_option" required>
                                    <option value="no" @if(old('limit_whatsapp_option',$package->limit_whatsapp_option)=='no') selected @endif>Tidak Terbatas</option>
                                    <option value="yes" @if(old('limit_whatsapp_option',$package->limit_whatsapp_option)=='yes') selected @endif>Terbatas</option>
                                </select>
                            </td>
                            <td>
                                <span class="badge-unlimited formwhatsapp-inf @if(old('limit_whatsapp_option',$package->limit_whatsapp_option) == 'yes') d-none @endif">∞</span>
                                <div class="formwhatsapp @if(old('limit_whatsapp_option',$package->limit_whatsapp_option) != 'yes') d-none @endif">
                                    <div class="input-group input-group-sm">
                            ...
                            <td>
                                <div class="formwhatsapp-priode @if(old('limit_whatsapp_option',$package->limit_whatsapp_option) != 'yes') d-none @endif">
                                    <select class="form-control" name="limit_whatsapp_priode">
                                        <option value="daily" @if(old('limit_whatsapp_priode',$package->limit_whatsapp_priode)=='daily') selected @endif>Harian</option>
                                        <option value="monthly" @if(old('limit_whatsapp_priode',$package->limit_whatsapp_priode)=='monthly') selected @endif>Bulanan</option>
                                        <option value="yearly" @if(old('limit_whatsapp_priode',$package->limit_whatsapp_priode)=='yearly') selected @endif>Tahunan</option>
                                    </select>
                                </div>
                                <span class="formwhatsapp-priode-na @if(old('limit_whatsapp_option',$package->limit_whatsapp_option) == 'yes') d-none @endif" style="color:#94A3B8;font-size:12px;">—</span>
                            </td>
                        </tr>
                        {{-- Email Blast --}}
                        <tr>
                            ...
                            <td>
                                <div class="formemail-priode @if(old('limit_email',$package->limit_email) != 'yes') d-none @endif">
                                    <select class="form-control" name="limit_email_priode">
                                        <option value="daily" @if(old('limit_email_priode',$package->limit_email_priode)=='daily') selected @endif>Harian</option>
                                        <option value="monthly" @if(old('limit_email_priode',$package->limit_email_priode)=='monthly') selected @endif>Bulanan</option>
                                        <option value="yearly" @if(old('limit_email_priode',$package->limit_email_priode)=='yearly') selected @endif>Tahunan</option>
                                    </select>
                                </div>
                                <span class="formemail-priode-na @if(old('limit_email',$package->limit_email) == 'yes') d-none @endif" style="color:#94A3B8;font-size:12px;">—</span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="form-control msglimit" name="message_limit_option" required>
                                    <option value="no" @if(old('message_limit_option',$package->message_limit_option ?? 'no')=='no') selected @endif>Tidak Terbatas</option>
                                    <option value="yes" @if(old('message_limit_option',$package->message_limit_option ?? 'no')=='yes') selected @endif>Terbatas</option>
                                </select>
                            </td>
                            <td>
                                <span class="badge-unlimited formmsg-inf @if(old('message_limit_option',$package->message_limit_option ?? 'no') == 'yes') d-none @endif">∞</span>
                                <div class="formmsg @if(old('message_limit_option',$package->message_limit_option ?? 'no') != 'yes') d-none @endif">
                                    <div class="input-group input-group-sm">
                                        <input class="form-control" name="message_limit" value="{{old('message_limit',(int)($package->message_limit ?? 0))}}" type="number" placeholder="5000">
                                        <span class="input-group-text">Pesan</span>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="formmsg-priode @if(old('message_limit_option',$package->message_limit_option ?? 'no') != 'yes') d-none @endif">
                                    <select class="form-control" name="message_limit_priode">
                                        <option value="monthly" @if(old('message_limit_priode',$package->message_limit_priode ?? 'monthly')=='monthly') selected @endif>Bulanan</option>
                                        <option value="daily" @if(old('message_limit_priode',$package->message_limit_priode ?? 'monthly')=='daily') selected @endif>Harian</option>
                                        <option value="yearly" @if(old('message_limit_priode',$package->message_limit_priode ?? 'monthly')=='yearly') selected @endif>Tahunan</option>
                                    </select>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="form-control scrappinglimit" name="limit_scrapp_option" required>
                                    <option value="no" @if(old('limit_scrapp_option',$package->limit_scrapp_option)=='no') selected @endif>Tidak Terbatas</option>
                                    <option value="yes" @if(old('limit_scrapp_option',$package->limit_scrapp_option)=='yes') selected @endif>Terbatas</option>
                                </select>
                            </td>
                            <td>
                                <span class="badge-unlimited formscrapping-inf @if(old('limit_scrapp_option',$package->limit_scrapp_option) == 'yes') d-none @endif">∞</span>
                                <div class="formscrapping @if(old('limit_scrapp_option',$package->limit_scrapp_option) != 'yes') d-none @endif">
                                    <div class="input-group input-group-sm">
                                        <input class="form-control" name="scrapp_limit" value="{{old('scrapp_limit',(int)$package->scrapp_limit)}}" type="number" placeholder="500">
                                        <span class="input-group-text">Data</span>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="formscrapping-priode @if(old('limit_scrapp_option',$package->limit_scrapp_option) != 'yes') d-none @endif">
                                    <select class="form-control" name="limit_scrapp_priode">
                                        <option value="daily" @if(old('limit_scrapp_priode',$package->limit_scrapp_priode)=='daily') selected @endif>Harian</option>
                                        <option value="monthly" @if(old('limit_scrapp_priode',$package->limit_scrapp_priode)=='monthly') selected @endif>Bulanan</option>
                                        <option value="yearly" @if(old('limit_scrapp_priode',$package->limit_scrapp_priode)=='yearly') selected @endif>Tahunan</option>
                                    </select>
                                </div>
                                <span class="formscrapping-priode-na @if(old('limit_scrapp_option',$package->limit_scrapp_option) == 'yes') d-none @endif" style="color:#94A3B8;font-size:12px;">—</span>
                            </td>
                        </tr>
                    </tbody>
                </table>
