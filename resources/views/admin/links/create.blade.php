...
<div class="row">
    <div class="col-xl-12">
        <form action="<?= route('links.store'); ?>" method="POST" class="card custom-card">
            @csrf
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-12 mt-3">
                        ...
                        <input class="form-control" name="url" value="{{old('url')}}" type="url" required>
                    </div>
                    <div class="col-lg-6 col-sm-12 mt-3">
                        <label class="form-label">{{__('cms.position')}}</label>
                        <select class="form-control" name="position" required>
                            <option value="1" @if(old('position') == 1) selected @endif>Header</option>
                            <option value="2" @if(old('position') == 2) selected @endif>Footer 1</option>
                            <option value="3" @if(old('position') == 3) selected @endif>Footer 2</option>
                            <option value="4" @if(old('position') == 4) selected @endif>Footer 3</option>
                        </select>
                    </div>
                    <div class="col-lg-6 col-sm-12 mt-3">
                        <label class="form-label">{{__('cms.order')}}</label>
                        <input class="form-control" name="order_position" value="{{old('order_position')}}" type="number" required>
                    </div> 
                </div>
            </div>
