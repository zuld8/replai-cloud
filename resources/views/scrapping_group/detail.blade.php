...
<div class="btn-list">
    <!-- <span class="d-none d-sm-inline">
        <a href="{{route('scrapping_group.export',$scrapping->id)}}" target="_blank" class="btn btn-dark">
    ...
    <a href="{{route('scrappings')}}" class="btn btn-info d-sm-none btn-icon" aria-label="{{__('scrapp.back_to')}}">
        <i class="bx bx-chevron-left"></i>
    </a>
</div>
@endsection
...
<script>
    $(document).ready(function() {
        const store_table = $('#storeData').DataTable({
            ...
            ajax: {
                "url": '/app/group-scrapping/detail/' + $("#scrapId").val(),
                "data": function(d) {
