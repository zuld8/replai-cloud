<!DOCTYPE html>
<html lang="en" dir="ltr" data-nav-layout="horizontal" data-theme-mode="light" data-menu-styles="light" loader="disable" data-nav-style="menu-click" data-default-header-styles="color">
...
<head>
    ...
    <head>
        ...
        <title>Replai.id — {{ isset($page) && $page ? $page : 'Business Portal' }}</title>
...
<body>
    ...
    <div class="page">
        ...
        <!-- Sidebar Component -->
        <x-starter.menu-component></x-starter.menu-component>
        ...
        <div class="d-block d-md-none">
            <div class="d-sm-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                <div>
                    <h4 class="fw-medium mb-2">{{$page}}</h4>
                    <div class="ms-sm-1 ms-0">
                        <nav>
                            <ol class="breadcrumb mb-0">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Dashboard</a></li>
                                <li class="breadcrumb-item active fw-normal" aria-current="page">{{$page}}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                <div class="d-flex my-auto mb-4">
    ...
    <!-- Page Header JS -->
    <script src="{{asset('assets/js/pageheader.js')}}"></script>
