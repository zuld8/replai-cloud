    ...
    <nav
        ...
        <div class="container">
            <a class="navbar-brand @@logo_classes" href="{{route('web.home')}}">
                <img class="navbar-brand-dark common" src="{{asset($settings->white_logo)}}" height="35" alt="{{$settings->app_name}}" />
                <img class="navbar-brand-light common" src="{{asset($settings->logo)}}" height="35" alt="{{$settings->app_name}}" />
            </a>
                    ...
                    <div class="row">
                        <div class="col-6 collapse-brand">
                            <a href="{{route('web.home')}}">
                                <img src="{{asset($settings->white_logo)}}" height="35" alt="{{$settings->app_name}}" />
                            </a>
                        </div>
