...
@section('title')
<i class="bx bx-magic fa-fw" aria-hidden="true"></i>
...
<div class="tabs tabs-full">
    ...
    <label for="tab1" class="tab-label">
        <i class="bx bx-cog fa-2x fa-fw" aria-hidden="true"></i>
        <br />
    ...
    <label for="tab2" class="tab-label">
        <i class="bx bx-data fa-2x fa-fw" aria-hidden="true"></i>
        <br />
    ...
    <form method="post" action="{{ route('MdhLicense::environmentSaveWizard') }}" class="tabs-wrap">
        <div class="tab" id="tab1content">
            ...
            <div class="form-group {{ $errors->has('app_name') ? ' has-error ' : '' }}">
                ...
                <span class="error-block">
                    <i class="bx fa-fw bxs-hand" aria-hidden="true"></i>
            ...
            <div class="form-group {{ $errors->has('app_debug') ? ' has-error ' : '' }}">
                ...
                <span class="error-block">
                    <i class="bx bxs-hand" aria-hidden="true"></i>
