...
<div class="container-fluid">
    ...
    <div class="row g-4">
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="row g-4">
                <!-- Kredit Pesan Package -->
                <div class="col-12">
                    <div class="card h-100 shadow-sm border-0">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="flex-grow-1">
                                    <p class="text-muted mb-2 fw-medium">Kredit Pesan dari Paket</p>
                                    <h3 class="mb-2 fw-bold">{{number_format($summaries['package_message_limit'])}}</h3>
                                    <small class="text-muted d-block">
                                        <i class="bx bx-info-circle me-1"></i>
                                        Kredit Pesan dari Paket Subscription Aktif
                                    </small>
                                </div>
                ...
                <div class="col-12">
                    <div class="card h-100 shadow-sm border-0">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="flex-grow-1">
                                    <p class="text-muted mb-2 fw-medium">Kredit Pesan Top Up</p>
                                    <h3 class="mb-2 fw-bold">{{number_format($summaries['topup_message_limit'])}}</h3>
                                    <small class="text-muted d-block">
                                        <i class="bx bx-infinite me-1"></i>
                                        Kredit Pesan dari Top Up Tambahan
                                    </small>
                                </div>
                                <div class="flex-shrink-0">
                                    <div class="avatar avatar-md bg-label-success rounded">
                                        <i class="bx bx-message-add bx-md"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <!-- Total Kredit Pesan Limit -->
                <div class="col-12">
                    <div class="card h-100 shadow-sm border-0">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="flex-grow-1">
                                    <p class="text-muted mb-2 fw-medium">Total Kredit Pesan Limit</p>
                                    <h3 class="mb-2 fw-bold">{{number_format($summaries['total_message_limit'])}}</h3>
                                    <small class="text-muted d-block">
                ...
                <div class="col-12">
                    <div class="card h-100 shadow-sm border-0">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="flex-grow-1">
                                    <p class="text-muted mb-2 fw-medium">Kredit Pesan Terpakai (30 Hari)</p>
                                    <h3 class="mb-2 fw-bold">{{number_format($summaries['message_used'])}}</h3>
                                    <small class="text-muted d-block">
                ...
                <div class="col-12">
                    <div class="card h-100 shadow-sm border-0 bg-gradient-primary">
                        <div class="card-body text-white">
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="flex-grow-1">
                                    <p class="text-white-50 mb-2 fw-medium">Sisa Kredit Pesan Tersedia</p>
                                    <h2 class="mb-2 fw-bold text-white">{{number_format($summaries['sisa_message_limit'])}}</h2>
                    ...
                    <ul class="nav nav-pills nav-justified w-100 tab-style-6" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#topup-tab"
                                ...
                                <span class="d-none d-sm-inline">Top Up Kredit Pesan</span>
                ...
                <div class="card-body">
                    <div class="tab-content">
                                ...
                                <table class="table table-hover align-middle">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th scope="col" class="text-nowrap">Kredit Pesan Limit</th>
                                    ...
                                    <tbody>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        <li>
                                                            <a class="dropdown-item" href="{{ route('message.billing.detail', $transaction->id) }}">
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item text-danger deletebutton"
                                                                href="{{ route('message.billing.delete', $transaction->id) }}">
                                        ...
                                        <tr>
                                            <td colspan="5" class="text-center py-5">
                                                ...
                                                <p class="text-muted mt-2 mb-0">Belum ada transaksi Kredit Pesan</p>
                                            </td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                        ...
                        <div class="tab-pane fade" id="topup-tab" role="tabpanel">
                            <form action="{{route('message.billing.create')}}" method="POST">
                                @csrf
                                <div class="row g-4">
                                    <div class="col-12">
                                        <div class="alert alert-info d-flex align-items-center" role="alert">
                                            ...
                                            <div>
                                                <strong>Informasi:</strong> 1 Qty = {{ number_format($internal->mua_per_price) }} Kredit Pesan (Kredit Pesan)
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label fw-semibold">Total Kredit Pesan Limit</label>
                                        <div class="input-group input-group-lg">
                                            <span class="input-group-text">
                                        ...
                                        <small class="text-muted">Limit Kredit Pesan yang akan Anda dapatkan</small>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="card bg-light border-0">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex justify-content-between mb-2">
                                                    <span class="text-muted">Kredit Pesan per Qty:</span>
