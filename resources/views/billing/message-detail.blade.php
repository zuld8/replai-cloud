...
<div class="row">
    ...
    <!-- Form Payment -->
    <div class="col-lg-12">
        <form action="{{$setting->method == 'bank' ? route('message.billing.store',$transaction->id) : route('message.billing.create.token',$transaction->id) }}" 
              method="POST" 
            ...
            <div class="card-header">
                <div class="card-title">
                    ...
                    {{__('starter.pay_bill')}} - Top Up Kredit Pesan
                </div>
                <div class="text-end">
                    <span class="badge bg-label-primary fs-6">
                        <i class="bx bx-group me-1"></i>
                        {{ number_format($transaction->new_order_message_limit) }} Kredit Pesan
                    </span>
                </div>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="alert alert-info d-flex align-items-start" role="alert">
                    ...
                    <div>
                        <strong>Petunjuk Pembayaran Top Up Kredit Pesan:</strong>
                        <ul class="mb-0 mt-2 ps-3">
                            <li>Kredit Pesan = Kredit Pesan (User unik yang chat dalam 30 hari)</li>
                            ...
                            <li>Limit Kredit Pesan akan bertambah: <strong>{{ number_format($transaction->new_order_message_limit) }} Users</strong></li>
            ...
            <div class="card-footer bg-light d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <small class="text-muted">
                        ...
                        +{{ number_format($transaction->new_order_message_limit) }} Kredit Pesan Limit
                    </small>
                </div>
    ...
    <div class="col-lg-12">
        <div class="card custom-card">
            <div class="card-body text-center py-5">
                ...
                <p class="text-muted">Pembayaran Top Up Kredit Pesan Anda sedang dalam proses verifikasi</p>
                ...
                <div class="mb-3">
                    <span class="badge bg-label-success fs-5">
                        <i class="bx bx-group me-1"></i>
                        +{{ number_format($transaction->new_order_message_limit) }} Kredit Pesan Limit Berhasil Ditambahkan
                    </span>
                </div>
                <a href="{{ route('message.billing.index') }}" class="btn btn-primary mt-3">
                    <i class="bx bx-left-arrow-alt me-1"></i>
                    Kembali ke Kredit Pesan Billing
                </a>
                @endif
            </div>
        </div>
