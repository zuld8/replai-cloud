...
<div class="row">
    ...
    <!-- Form Payment -->
    <div class="col-lg-12">
        <form action="{{$setting->method == 'bank' ? route('billing.store',$transaction->id) : route('billing.create.token',$transaction->id) }}" 
              method="POST" 
    ...
    <div class="col-lg-12">
        <div class="card custom-card">
            <div class="card-body text-center py-5">
                ...
                <p class="text-muted">Pembayaran Anda sedang dalam proses verifikasi</p>
                ...
                <a href="{{ route('billing.index') }}" class="btn btn-primary mt-3">
