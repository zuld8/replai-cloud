            ...
            <div class="card custom-card mb-3">
                <div class="card-header">
                    <div class="card-title">
                        <i class="bx bx-user-circle me-2"></i>{{__('contact.contact_information')}}
                    </div>
                </div>
                <div class="card-body">
                    <!-- Nama Kontak -->
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="name" 
                                   placeholder="{{__('contact.contact_name')}}" 
                                   required value="<?= old('name', $store->name); ?>">
                        </div>
                        <small class="text-muted">
                            <i class="bx bx-info-circle me-1"></i>{{__('contact.full_name_help')}}
                        </small>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" name="label">
                            ...
                            <option value="<?= $label->id; ?>" @if($label->id == $store->label_id) selected @endif>
                                <?= $label->name; ?>
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-semibold">
                            <i class="bx bx-info-square me-1"></i>{{__('contact.status')}}
                            <span class="text-danger">*</span>
                        </label>
                        <div class="input-group">
                            <span class="input-group-text">
                            ...
                            <select class="form-control" name="status" required>
                                <option value="no" @if($store->status == 'no') selected @endif>
                                    {{__('contact.active')}}
                                </option>
                                <option value="yes" @if($store->status == 'yes') selected @endif>
                                    {{__('contact.inactive')}}
                                </option>
                            </select>
                        </div>
                        <small class="text-muted">
                            <i class="bx bx-info-circle me-1"></i>{{__('contact.status_help')}}
                        </small>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control provinces" name="province">
                            ...
                            <option value="<?= $province->id; ?>" 
                                    @if(($store->district->city->province_id ?? '') == $province->id) selected @endif>
                                <?= $province->name; ?>
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control cities" name="city">
                            <option value="<?= $store->district->city->id ?? ''; ?>">
                                <?= $store->district->city->type ?? ''; ?>
                                <?= $store->district->city->name ?? ''; ?>
                            </option>
                        </select>
                        <small class="text-muted">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control districts" name="district">
                            <option value="<?= $store->district_id; ?>">
                                <?= $store->district->name ?? ''; ?>
                            </option>
                        </select>
                        <small class="text-muted">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div class="d-flex gap-2">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="bx bx-save me-1"></i>{{__('general.save_change')}}
                    </button>
                </div>
            </div>
        </form>
