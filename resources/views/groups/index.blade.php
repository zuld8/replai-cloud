    ...
    <div class="col-xl-12">
        ...
        <div class="card custom-card">
            <div class="card-header d-flex justify-content-between">
                <div class="card-title">{{__('scraping.group.group_list')}}</div>
                ...
                <table id="scrappingData" class="table table-bordered text-nowrap" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">{{__('scraping.group.device')}}</th>
                            <th scope="col">{{__('scraping.group.group_id')}}</th>
                            <th scope="col">{{__('scraping.group.contacts')}}</th>
                            <th scope="col">{{__('scraping.group.syncron')}}</th>
...
<script>
    ...
    function activationData(id, thisdata) {
        $.ajax({
            url: `/app/whatsapp-group/status/${id}`,
            type: 'POST',
            headers: {
