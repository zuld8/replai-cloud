...
<div class="row">
    ...
    <div class="col-xl-12">
        <form action="<?= route('label.store'); ?>" method="POST" class="card custom-card">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                    ...
                    <div class="col-12 mt-3">
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control" name="tag" type="text" placeholder="{{__('master.label.tag_placeholder')}}" required>
                        </div>
                    </div>
