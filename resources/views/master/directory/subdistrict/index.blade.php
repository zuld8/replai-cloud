                ...
                <table id="districtData" class="table table-bordered text-nowrap" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">{{__('master.district.district')}}</th>
                            <th scope="col">{{__('sidebar.city')}}</th>
                            <th scope="col">{{__('sidebar.state')}}</th>
                            <th scope="col">{{__('master.district.postal_code')}}</th> 
                        </tr>
                    </thead>
                    <tbody> </tbody>
                </table>
...
<script>
    $(document).ready(function() {
        const district_table = $('#districtData').DataTable({
            responsive: true,
            language: {
                searchPlaceholder: '{{__('master.district.search')}}',
                sSearch: '',
            },
            "pageLength": 25,
            processing: true,
            ...
            ajax: {
                "url": '/app/master/directory/subdistricts?' + $("#paramsData").val(),
                "data": function(d) {
