...
<div class="btn-list">
    <a href="{{ route('ticket.labels') }}" class="btn btn-primary">
        ...
        {{ __('master.ticket_label.ticket_label_list') }}
    </a>
</div>
@endsection
...
<div class="row">
    ...
    <div class="col-xl-12">
        <form action="<?= route('ticket.label.edit', $label->id); ?>" method="POST" class="card custom-card">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                    ...
                    <div class="col-12 mt-3">
                        ...
                        <small class="d-block text-muted mb-2">{{ __('master.ticket_label.keyword_desc') }}</small>
                        <div class="input-group">
