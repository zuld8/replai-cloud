...
@section('button')
<div class="btn-list">
    <a href="{{route('scrapping_contact.create')}}" class="btn btn-primary d-none d-sm-inline-block">
        <i class="bx bx-plus-circle"></i>
        {{__('general.add_data')}}
    </a>
    <a href="{{route('scrapping_contact.create')}}" class="btn btn-info d-sm-none btn-icon" aria-label="{{__('general.add_data')}}">
        <i class="bx bx-plus-circle"></i>
    </a>
</div>
@endsection
...
<script>
    $(document).ready(function() {
        const scrapping_table = $('#scrappingData').DataTable({
            ...
            ajax: {
                "url": '/app/contact-scrapping?' + $("#paramsData").val(),
                "data": function(d) {
