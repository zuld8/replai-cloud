...
<head>
    <title>{{$setting->app_name}} - Verifikasi Email</title>
                        ...
                        <td style="padding: 0; position: relative;">
                            <div style="width: 100%; text-align: center; margin-top: -60px; position: relative; z-index: 10;">
                                <div style="display: inline-block; background: linear-gradient(135deg, #ffffff 0%, #f9fafb 100%); border-radius: 20px; padding: 20px; box-shadow: 0 8px 32px rgba(69, 135, 87, 0.2);">
                                    <img src="<?= asset('assets/img/icons/verification.png'); ?>" alt="Verification" style="width: 120px; height: auto; display: block;" />
                                </div>
                            </div>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    <td align="center">
                                        ...
                                        <p style="margin: 0 0 20px 0; color: #4b5563; font-size: 15px; line-height: 1.6;">
                                            Terima kasih telah mendaftar di <strong style="color: #458757;">{{$setting->app_name}}</strong>.
                                            Untuk melanjutkan, silakan verifikasi alamat email Anda dengan mengklik tombol di bawah ini.
                                        </p>

                                        <!-- Important Notice -->
                                        <div style="background-color: #fef3c7; border-left: 4px solid #f59e0b; border-radius: 8px; padding: 16px; margin: 20px 0; text-align: left;">
                                            <p style="margin: 0; color: #92400e; font-size: 13px; line-height: 1.5;">
                                                <strong>⚠️ Penting:</strong> Pastikan Anda sudah login di browser sebelum mengklik tombol verifikasi.
                                            </p>
                                        </div>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td style="padding: 0 40px 40px 40px;">
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                                    <td align="center">
                                        <a href="<?= $url; ?>" class="button-link" style="display: inline-block; background: linear-gradient(135deg, #458757 0%, #5fa973 100%); color: #ffffff; font-size: 16px; font-weight: 600; text-decoration: none; padding: 16px 48px; border-radius: 12px; box-shadow: 0 4px 16px rgba(69, 135, 87, 0.3); transition: all 0.3s ease;" target="_blank">
                                ...
                                <tr>
                                    <td style="padding-top: 30px;">
                                        ...
                                        <div style="background-color: #f9fafb; border: 1px solid #e5e7eb; border-radius: 8px; padding: 12px; margin-top: 12px; word-break: break-all;">
                                            <a href="<?= $url; ?>" style="color: #458757; font-size: 12px; text-decoration: none; word-break: break-all;">
                                                <?= $url; ?>
                                            </a>
                                        </div>
                                    </td>
