...
@section('button')
<div class="btn-list">
    <a href="{{route('messenger')}}" class="btn btn-outline-secondary">
...
<div class="row d-flex justify-content-center">
    <div class="col-xl-9">
        ...
        <form action="<?= route('messenger.edit', $messenger->id); ?>" enctype="multipart/form-data" method="POST">
            @csrf
            ...
            <div class="card custom-card mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control users" name="agent[]" multiple="multiple" required>
                            ...
                            <option value="<?= $user->id; ?>"
                                {{ in_array($user->id, explode(',', $messenger->agent)) ? 'selected' : '' }}>
                                <?= $user->name; ?>
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-control methodreply" name="method" required>
                                <option value="all" @if($messenger->auto_reply_method == 'all') selected @endif>{{__('platform.telegram.method_all')}}</option>
                                <option value="chatbot" @if($messenger->auto_reply_method == 'chatbot') selected @endif>{{__('platform.telegram.method_chatbot')}}</option>
                                <option value="ai" @if($messenger->auto_reply_method == 'ai') selected @endif>{{__('platform.telegram.method_ai')}}</option>
                            </select>
                        </div>
                        <small class="text-muted">
                    ...
                    <div class="mb-3 finetunneldata @if($messenger->auto_reply_method == 'chatbot') d-none @endif">
                        <label class="form-label fw-semibold">
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-control" name="tunnel">
                                ...
                                <option value="{{$t->id}}" @if($messenger->fine_tunnel_id == $t->id) selected @endif>{{$t->name}}</option>
                                @endforeach
                            </select>
                        </div>
                        <small class="text-muted">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-control" name="auto_reply_option" required>
                                <option value="all" @if($messenger->auto_reply_option == 'all') selected @endif>{{__('platform.telegram.reply_all')}}</option>
                                <option value="personal" @if($messenger->auto_reply_option == 'personal') selected @endif>{{__('platform.telegram.reply_personal')}}</option>
                                <option value="group" @if($messenger->auto_reply_option == 'group') selected @endif>{{__('platform.telegram.reply_group')}}</option>
                            </select>
                        </div>
                        <small class="text-muted">
            ...
            <div class="card custom-card mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <div class="toggle-wrapper">
                            ...
                            <label class="toggle-switch">
                                <input type="checkbox" class="certain_day_toggle" name="certain_day" value="yes" <?= $messenger->auto_reply_certain_day == 'yes' ? 'checked' : '' ?>>
                    ...
                    <!-- Pilihan Hari -->
                    <div class="mb-3 @if($messenger->auto_reply_certain_day == 'no') d-none @endif" id="certain_day_select">
                        <label class="form-label fw-semibold">
                        ...
                        <select class="form-control days" name="days[]" multiple="multiple">
                            @php
                            $selectedDays = $messenger->days ? explode(',', $messenger->days) : [];
                            @endphp
                    ...
                    <div class="mb-3">
                        <div class="toggle-wrapper">
                            ...
                            <label class="toggle-switch">
                                <input type="checkbox" class="certain_time_toggle" name="certain_time" value="yes" <?= $messenger->auto_reply_certain_time == 'yes' ? 'checked' : '' ?>>
                                <span class="toggle-slider"></span>
                            </label>
                        </div>
                    </div>
                    ...
                    <!-- Jam Mulai & Selesai -->
                    <div class="row @if($messenger->auto_reply_certain_time == 'no') d-none @endif" id="time_inputs">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" name="start_time" type="time" value="<?= $messenger->start_time; ?>">
                            </div>
                            <small class="text-muted">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" name="end_time" type="time" value="<?= $messenger->end_time; ?>">
                            </div>
                            <small class="text-muted">
                    ...
                    <div class="mb-3">
                        <div class="toggle-wrapper">
                            ...
                            <label class="toggle-switch">
                                <input type="checkbox" class="daily_limit_toggle" name="daily_limit" value="yes" <?= $messenger->daily_limit == 'yes' ? 'checked' : '' ?>>
                                <span class="toggle-slider"></span>
                            </label>
                        </div>
                    </div>
                    ...
                    <!-- Batas Harian -->
                    <div class="mb-3 @if($messenger->daily_limit == 'no') d-none @endif" id="daily_limit_input">
                        <label class="form-label fw-semibold">
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control" name="limit" value="<?= old('limit', $messenger->limit_per_day); ?>" type="number" placeholder="{{__('platform.telegram.daily_limit_placeholder')}}">
