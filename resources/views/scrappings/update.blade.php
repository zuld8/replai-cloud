...
@section('content')
<form action="<?= route('scrappings.edit', $scrapping->id); ?>" method="POST" class="row d-flex justify-content-center">
    @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 mb-4">
                        ...
                        <select class="form-control provinces" name="province">
                            ...
                            <option value="<?= $province->id; ?>" 
                                    @if(($scrapping->district->city->province_id ?? '') == $province->id) selected @endif>
                                <?= $province->name; ?>
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-lg-12 mb-4">
                        ...
                        <select class="form-control districts" name="district">
                            <option value="<?= $scrapping->district_id; ?>">
                                <?= $scrapping->district->name ?? ''; ?>
                            </option>
                        </select>
                        <small class="text-muted">
                            <i class="bx bx-info-circle"></i>
