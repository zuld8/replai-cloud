...
.chat-avatar-messenger .messenger-icon-bg {
    width: 100%;
    height: 100%;
...
.chat-avatar-messenger .messenger-icon-bg i {
    font-size: 22px;
    color: #fff;
}
.chat-avatar-messenger .messenger-photo {
    position: absolute;
    top: 0; left: 0;
    width: 100%;
    height: 100%;
...
.chat-header-right .badge-unread {
    background: #25d366;
    color: #fff;
    font-size: 10px;
    font-weight: 700;
...
.chat-header-right .chat-time {
    font-size: 11px;
    color: #8b8fa7;
    white-space: nowrap;
}

/* WABA/Device name row — right-aligned */
.chat-device-row {
    display: flex;
    align-items: center;
...
.chat-device-row .device-logo {
    font-size: 10px;
    color: #a8d8a8;
}
.chat-device-row .device-logo i {
    vertical-align: middle;
}
.chat-device-row .device-label {
    overflow: hidden;
    text-overflow: ellipsis;
    white-space: nowrap;
    max-width: 180px;
