                ...
                <div class="card-body py-3">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-8 d-flex justify-content-between align-items-end">
                            ...
                            <div class="ms-3">
                                <button type="button" class="btn btn-primary" @click="showAddLabelModal">
                                    <i class="bx bx-plus-circle me-1"></i>{{ $t('add_label') }}
                                </button>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li>
                                            <a class="dropdown-item" href="#" @click.prevent="showEditLabelModal(label)">
                                        ...
                                        <li>
                                            <a class="dropdown-item text-danger" href="#" @click.prevent="confirmDeleteLabel(label.id)">
                ...
                <div class="modal-content">
                    ...
                    <form @submit.prevent="submitLabel">
                        <div class="modal-body">
                            <div class="row g-3">
                                <div class="col-12">
                                    <label class="form-label">{{ $t('label_name') }} <span class="text-danger">*</span></label>
                                ...
                                <div class="col-12">
                                    <label class="form-label">{{ $t('label_tag') }} <span class="text-danger">*</span></label>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input 
                                            type="text" 
                                            class="form-control" 
                                            v-model="newLabel.tag" 
                                            :placeholder="$t('label_tag_placeholder')" 
                                            required>
                                    </div>
                                </div>
                                
                                <div class="col-md-6">
                                    <label class="form-label">{{ $t('label_position') }} <span class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <span class="input-group-text"><i class="bx bx-sort"></i></span>
                                        <input 
                                            type="number" 
                                            class="form-control" 
                                            v-model="newLabel.position" 
                                            min="1" 
                                            placeholder="1" 
                                            required>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label">{{ $t('label_color') }} <span class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <input 
                                            type="color" 
                                            class="form-control" 
                                            v-model="newLabel.color" 
                                            @input="updateColorHex"
                    ...
                    <form @submit.prevent="submitEditLabel">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary" :disabled="isEditingLabel">
                                <span v-if="isEditingLabel" class="spinner-border spinner-border-sm me-2" role="status"></span>
                                <i v-else class="bx bx-save me-1"></i>
                                {{ $t('update_label') }}
                            </button>
                        </div>
    ...
    methods: {
        ...
        $t(key) {
            ...
            const translations = {
                ...
                'label_tag': 'Label Tag/Keyword',
                'label_tag_desc': 'Keywords that will trigger this label assignment',
                'label_tag_placeholder': 'e.g., urgent, complaint, billing',
                'label_position': 'Position Index',
                ...
                'confirm_delete_label_title': 'Delete Label?',
                'confirm_delete_label_text': 'Are you sure you want to delete this label? All tickets in this label will be moved to "New Tickets".',
                'yes_delete_label': 'Yes, Delete Label!'
            };
        ...
        async submitLabel() {
            ...
            try {
                ...
                // Add to labels array
                this.labels.push(newLabelData);
                
                // Sort by position
                this.labels.sort((a, b) => a.position - b.position);
        ...
        async submitEditLabel() {
            ...
            try {
                ...
                const labelIndex = this.labels.findIndex(l => l.id === this.editingLabel.id);
                if (labelIndex !== -1) {
        ...
        async deleteLabel(labelId) {
            try {
                ...
                const labelToDelete = this.labels.find(l => l.id === labelId);
                if (!labelToDelete) return;

                // Move all stores from deleted label to "New Tickets"
                const newTicketsLabel = this.labels.find(l => l.name === 'New Tickets');
                if (newTicketsLabel && labelToDelete.stores.length > 0) {
                    // Move stores to New Tickets
                    newTicketsLabel.stores = [...newTicketsLabel.stores, ...labelToDelete.stores];
                    newTicketsLabel.total_stores += labelToDelete.total_stores;
                    newTicketsLabel.loaded_count += labelToDelete.loaded_count;
                    
                    // Update label property of moved stores
                    labelToDelete.stores.forEach(store => {
                        store.label = 'New Tickets';
                    });
                }
