                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-4">
                        ...
                        <select class="form-control livechats" name="livechats[]" multiple="multiple">
                                ...
                                <option value="<?= $livechat->id; ?>"><?= $livechat->name; ?></option>
                                @endforeach
                            </select>
                        <small class="text-muted">
                            <i class="bx bx-info-circle"></i>
                    ...
                    <div class="col-lg-6 mb-4">
                        <label class="form-label fw-semibold">
                         ...
                         <select class="form-control telegrams" name="telegrams[]" multiple="multiple">
                                ...
                                <option value="<?= $telegram->id; ?>"><?= $telegram->name; ?></option>
                                @endforeach
                            </select>
                        <small class="text-muted">
                            <i class="bx bx-info-circle"></i>
                      ...
                      <div class="col-lg-6 mb-4">
                        <label class="form-label fw-semibold">
                         ...
                         <select class="form-control instagrams" name="instagrams[]" multiple="multiple">
                                ...
                                <option value="<?= $instagram->id; ?>"><?= $instagram->name; ?></option>
                                @endforeach
                            </select>
                        <small class="text-muted">
                            <i class="bx bx-info-circle"></i>
                    ...
                    <div class="col-lg-6 mb-4">
                        <label class="form-label fw-semibold">
                            ...
                            Pilih WhatsApp Business API (WABA)
                            <span class="badge bg-label-secondary ms-1">{{__('chatbot.optional')}}</span>
                        </label>
                        <select class="form-control wabas" name="wabas[]" multiple="multiple">
                            @foreach ($wabaDevices ?? [] as $wdev)
                            @php
                                $wMeta = json_decode($wdev->meta_data, true);
                                $wName = $wMeta['whatsapp']['verified_name'] ?? $wdev->phone;
                            @endphp
                            <option value="{{ $wdev->id }}">{{ $wName }} — {{ $wdev->phone }}</option>
                            @endforeach
                        </select>
                        <small class="text-muted">
                            <i class="bx bx-info-circle"></i>
                            Pilih akun WABA untuk auto-reply pesan WhatsApp Business API
                        </small>
                    </div>
...
<div class="col-lg-6 mb-4">
                        <label class="form-label fw-semibold">
                         ...
                         <select class="form-control messengers" name="messengers[]" multiple="multiple">
                                ...
                                <option value="<?= $messenger->id; ?>"><?= $messenger->page_name; ?></option>
                                @endforeach
                            </select>
                        <small class="text-muted">
                            <i class="bx bx-info-circle"></i>
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-control methodreply" name="method" required>
                                <option value="template">
                                    <i class="bx bx-file"></i> {{__('general.template')}}
                                </option>
                                <option value="text">
                                    <i class="bx bx-text"></i> {{__('general.text')}}
                                </option>
                                <option value="image">
                                    <i class="bx bx-image"></i> {{__('chatbot.image')}}
                                </option>
                            </select>
                        </div>
                        <small class="text-muted">
                    ...
                    <!-- Template Form -->
                    <div class="col-lg-12 mb-4 templateform">
                        <label class="form-label fw-semibold">
                    ...
                    <!-- Message Form -->
                    <div class="col-12 mb-4 messageform d-none">
                        <label class="form-label fw-semibold">
                        ...
                        <div class="input-group">
                            ...
                            <textarea class="form-control"
                                ...
                                name="message"
                                placeholder="{{__('chatbot.write_your_message_here')}}">{{old('message')}}</textarea>
                        </div>
                        <small class="text-muted">
                            <i class="bx bx-info-circle"></i>
                            {{__('chatbot.write_your_reply_message')}}
                        </small>
                    </div>

                    <!-- Image List -->
                    <div class="col-12 listImage d-none">
...
<script>
    $(document).ready(function() {
        // Initialize Select2
        $('.devices').select2({
            placeholder: '{{__('chatbot.choose_device_select')}}',
            allowClear: true
        });

        $('.telegrams').select2({
            placeholder: '{{__('chatbot.choose_telegram_select')}}',
            allowClear: true
        });

        $('.livechats').select2({
            placeholder: '{{__('chatbot.choose_livechat_select')}}',
            allowClear: true
        });
